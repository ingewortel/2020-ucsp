...
\clip (-0.2,0) rectangle +(18,-15.5);
	...
	\begin{scope}[yshift=-5.65cm]
		...
		\begin{scope}[yshift=-0.5cm]
			...
			\node[anchor = north west] at (0.3,0){
				\includegraphics{../twodim/plots/panelB-2D.pdf}
			};
		...
		\begin{scope}[yshift=-4.8cm]
			\node[anchor = north west] at (0.3,0){
				\includegraphics{../plots/panelB-3D.pdf}
			};
			...
			\begin{scope}[xshift=1.8cm,yshift=-1.2cm]
				\clip (0.2,-0.15) rectangle +(1,-1);
				\node[anchor=north west,scale=0.15] at (0.25,-0.1){
					\includegraphics{../example-img/3D-m30l40.png}
				};
				\node[anchor=north west] at (0.2,-0.15) {A};
			\end{scope}
			\draw[line width=0.2mm] (2,-1.35) rectangle +(1,-1);
			\draw[dashed, line width=0.2mm] (2,-2.35) -- +(1,-0.7);
	
			\filldraw[white] (5.15,-2.8) rectangle +(1,-1);
			\begin{scope}[xshift=5.1cm,yshift=-2.55cm]
				\clip (0.05,-0.25) rectangle +(1,-1);
				\node[anchor=north west,scale=0.21] at (-0.1,-0.35){
					\includegraphics{../example-img/3D-m30l48.png}
				};
			...
			\begin{scope}[xshift=6.7cm,yshift=-1.2cm]
				\clip (0.2,-0.15) rectangle +(1,-1);
				\node[anchor=north west,scale=0.35] at (-0.35,0.25){
					\includegraphics{../example-img/3D-m50l33.png}
				};
				\node[anchor=south west] at (0.2,-1.15) {A};
			\end{scope}
			\draw[line width=0.2mm] (6.9,-1.35) rectangle +(1,-1);
			\draw[dashed, line width=0.2mm] (7.9,-2.35) -- +(0.4,-0.45);
	
			\filldraw[white] (10.05,-2.8) rectangle +(1,-1);
			\begin{scope}[xshift=9.7cm,yshift=-2.55cm]
				\clip (0.35,-0.25) rectangle +(1,-1);
				\node[anchor=north west,scale=0.15] at (0.4,-0.15){
					\includegraphics{../example-img/3D-m50l37.png}
				};
				\node[anchor=south west] at (0.35,-1.25) {K};
			\end{scope}	
			\draw[line width=0.2mm] (10.05,-2.8) rectangle +(1,-1);
			\draw[dashed, line width=0.2mm] (11.05,-2.8) -- +(-0.6,1);
			\end{scope}
		\end{scope}
	...
	\begin{scope}[xshift = 11.4cm]
		...
		\node[anchor = north west] at (0.63,0){
			\includegraphics{../plots/panelC-2D.pdf}
		};
		\node[anchor = north west] at (0.4,-0.3){2D};
		\node[anchor = north west] at (0.63,-7.35){
			\includegraphics{../plots/panelC-3D.pdf}
		};
