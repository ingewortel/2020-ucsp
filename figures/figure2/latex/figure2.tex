...
\begin{scope}[xshift=11.7cm]
	\node[anchor = north west] at (0.3,-0.7){
		\includegraphics{../onedim/plots/speed-persistence-phalf.pdf}
	};
	\node[anchor = north] at (4,-0.6) {1D};
	\node[anchor = north west] at (0.3,-4.7){
		\includegraphics{../twodim/plots/2D-speed-persistence-phalf.pdf}
	};
	\node[anchor = north] at (4,-4.6) {2D};
	\node[anchor = north west] at (0.3,-8.7){
		\includegraphics{../threedim2-geom/plots/3D-speed-persistence-phalf.pdf}
	};
...
\begin{scope}[yshift=-7.7cm]
	...
	\node[anchor = north west] at (0,0){
		\includegraphics{../onedim/plots/1Dmain.pdf}
	};
