...
\begin{tikzpicture}[anchor=north west]
	...
	\begin{scope}[yshift=0cm]
		\node[anchor = north west] at (0.2,0) {
			\includegraphics{./img/skin-setup3.pdf}
		};
		...
		\begin{scope}
			...
			\begin{scope}[xshift=1cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (-1.3,0.5) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact30-lact1000/stop-t0.png}
				};
			\end{scope}
			...
			\begin{scope}[xshift=3.2cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (-1.3,0.5) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact30-lact1000/go-t15.png}
				};
			\end{scope}
		\end{scope}
		...
		\begin{scope}[xshift=4.8cm]
			...
			\begin{scope}[xshift=1cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (0,0.7) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact30-lact2000/t0.png}
				};
			\end{scope}
			...
			\begin{scope}[xshift=3.2cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (0,0.7) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact30-lact2000/t10.png}
				};
			\end{scope}
		\end{scope}
		...
		\begin{scope}[yshift=-3.65cm]
			...
			\begin{scope}[xshift=1cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (0,2.1) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact300/t0.png}
				};
			...
			\begin{scope}[xshift=3.2cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (0,2.1) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact300/t20.png}
				};
		...
		\begin{scope}[xshift=4.8cm,yshift=-3.65cm]
			...
			\begin{scope}[xshift=1cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (-0.5,1.5) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact1000/t40.png}
				};
				%\draw[->] (1.05,-1.0) -- +(0.25,-0.05);
			\end{scope}
			...
			\begin{scope}[xshift=3.2cm, yshift=-1.1cm]
				...
				\node[anchor = north west, scale = 0.4 ] at (-0.5,1.5) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact1000/t65.png}
				};
				%\draw[->] (0.95,-1.2) -- +(-0.05,-0.2);
			\end{scope}
		\end{scope}
		...
		\begin{scope}[xshift=0.1cm,yshift=-0.3cm]
			...
			\begin{scope}[xshift=1cm, yshift=-0.3cm]
				...
				\node[anchor = north west, scale = 0.3 ] at (-0.6,0.75) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact1000/t146.png}
				};
				%\draw[->] (1.05,-1.0) -- +(0.25,-0.05);
			\end{scope}
			...
			\begin{scope}[xshift=2.8cm, yshift=-0.3cm]
				...
				\node[anchor = north west, scale = 0.3 ] at (-0.6,0.75) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact1000/t167.png}
				};
				%\draw[->] (0.95,-1.2) -- +(-0.05,-0.2);
			\end{scope}
			...
			\begin{scope}[xshift=4.6cm, yshift=-0.3cm]
				...
				\node[anchor = north west, scale = 0.3 ] at (-0.6,0.75) {
					\includegraphics{../skin-big/skin-imgs/stiff-mact100-lact1000/t187.png}
				};
				%\draw[->] (0.95,-1.2) -- +(-0.05,-0.2);
			\end{scope}
		\end{scope}
		...
		\begin{scope}[xshift=0.1cm,yshift=-2.5cm]
			...
			\begin{scope}[xshift=1cm, yshift=-0.3cm]
				...
				\node[anchor = north west, scale = 0.3 ] at (-1.5,0.15) {
					\includegraphics{../skin-big/skin-imgs/deformable-mact100-lact1000/t67.png}
				};
				%\draw[->] (1.05,-1.0) -- +(0.25,-0.05);
			\end{scope}
			...
			\begin{scope}[xshift=2.8cm, yshift=-0.3cm]
				...
				\node[anchor = north west, scale = 0.3 ] at (-1.5,0.15) {
					\includegraphics{../skin-big/skin-imgs/deformable-mact100-lact1000/t97.png}
				};
				%\draw[->] (0.95,-1.2) -- +(-0.05,-0.2);
			\end{scope}
			...
			\begin{scope}[xshift=4.6cm, yshift=-0.3cm]
				...
				\node[anchor = north west, scale = 0.3 ] at (-1.5,0.15) {
					\includegraphics{../skin-big/skin-imgs/deformable-mact100-lact1000/t127.png}
				};
				%\draw[->] (0.95,-1.2) -- +(-0.05,-0.2);
			\end{scope}
		\end{scope}
	...
	\begin{scope}[xshift = 6.9cm,yshift=-7cm]
		\node[anchor = north west] at (0,0) {
			\includegraphics{../skin-big/plots/skin-facet-speed-persistence-phalf.pdf}
		};
