...
\begin{scope}[yshift=-8cm]
	...
	\begin{scope}[xshift=10.7cm, yshift=-0.5cm]
		...
		\begin{scope}[xshift=0,yshift=0.35cm]
			\clip (0.05,-0.25) rectangle +(1.5,-1.5);
			\node[anchor=north west,scale=0.36] at (-0.2,0){
				\includegraphics{../example-img/3D-m30l48.png}
			};
		\end{scope}
		\begin{scope}[xshift=1.7cm,yshift=0.25cm]
			\clip (0.05,-0.15) rectangle +(1.5,-1.5);
			\node[anchor=north west,scale=0.32] at (-0.2,0){
				\includegraphics{../example-img/3D-m30-l52.png}
			};
		\end{scope}
		\draw (0.05,0.1) rectangle +(1.5,-1.5);
		\draw (1.75,0.1) rectangle +(1.5,-1.5);
	...
	\begin{scope}[xshift=14.2cm, yshift=-0.5cm]
		...
		\begin{scope}[xshift=0,yshift=0.35cm]
			\clip (0.05,-0.25) rectangle +(1.5,-1.5);
			\node[anchor=north west,scale=0.56] at (-0.3,0){
				\includegraphics{../example-img/3D-m50-l36.png}
			};
		\end{scope}
		\begin{scope}[xshift=1.7cm,yshift=0.25cm]
			\clip (0.05,-0.15) rectangle +(1.5,-1.5);
			\node[anchor=north west,scale=0.52] at (-0.5,0){
				\includegraphics{../example-img/3D-m50-l40.png}
			};
		\end{scope}
		\draw (0.05,0.1) rectangle +(1.5,-1.5);
		\draw (1.75,0.1) rectangle +(1.5,-1.5);
...
\draw[dashed] (3.4,-1.3) -- +(0,-1.8);
\draw[dashed] (3.4,-3.7) -- +(0,-1.1);
\draw[dashed] (3.4,-5.3) -- +(0,-1.8);
\draw[dashed] (3.4,-7.7) -- +(0,-0.7);

\draw[dashed] (6.0,-1.3) -- +(0,-7.1);
...
\draw[dashed] (13.13,-1.3) -- +(0,-3.3);
%\draw[dashed] (12.73,-3.7) -- +(0,-1.1);
\draw[dashed] (13.13,-5.3) -- +(0,-1.8);
\draw[dashed] (13.13,-7.2) -- +(-0.9,-1.2);

\draw[dashed] (13.6,-1.3) -- +(0,-7.1);
